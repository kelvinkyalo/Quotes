...
export class QuoteComponent implements OnInit {
  ...
  quotes: Quote[] = [
      new Quote(1,"The greatest glory in living lies not in never falling, but in rising every time we fall.","Author-Nelson Mandela","Nelson", new Date(2020,3,14)),  new Quote(2,"The way to get started is to quit talking and begin doing.","Author -Walt Disney","Walt",new Date(2020,3,14)),
